export const service = [
    { id: 1, label: 'Lessive', icon: require('../assets/images/Lessive.png'),lien:`../ListServices/Lessive` },
    { id: 2, label: 'Menage', icon: require("../assets/images/Menage.png"),lien:`../ListServices/Menage` },
    { id: 3, label: 'Désinfection', icon: require('../assets/images/Desinfection.png'),lien:`../ListServices/Desinfection` },
    ...
    { id: 6, label: 'cuisinière', icon: require('../assets/images/Cuisinière.png'),lien:`../ListServices/Cuisinière` },
