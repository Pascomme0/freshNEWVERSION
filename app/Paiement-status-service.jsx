...
import {setClearPanier} from "./panierServiceSlice";
...
function LoadingScreenApp() {
    ...
    const cmd = useSelector(state => state.panierService.activeCommand);
    const payLink = useSelector(state => state.panierService.activePayLink);
