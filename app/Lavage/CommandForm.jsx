  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} className="bg-white p-4">
        ...
        <View className="mb-4">
          <StyledText className="font-bold mb-2">Date de retrait</StyledText>
          <TouchableOpacity onPress={showDatePicker}>
            <TextInput
              className="h-12 border border-gray-300 p-2 rounded shadow-sm"
        ...
        <View className="mb-4">
          <StyledText className="font-bold mb-2">Heure de retrait</StyledText>
          <TouchableOpacity onPress={() => showTimePicker('dropoff')}>
            <TextInput
              className="h-12 border border-gray-300 p-2 rounded shadow-sm"
              placeholder="Heure de retrait"
              value={selectedTime.dropoff}
              editable={false}
            />
          </TouchableOpacity>
        </View>
