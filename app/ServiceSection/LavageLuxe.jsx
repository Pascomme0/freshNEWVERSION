...
function LavageLuxeApp() {
    ...
    useEffect(() =>{
        const initialize = async () => {
            setLoading(true);
            const response = await axios.get(url + "/api/produits?isVente=0&priceProduits.service=/api/services/8");
...
export default function LavageLuxe() {
    return (
