...
function DesinsectisationDetailApp () {
            ...
            <View className='mb-10 '>
                <StyledView style={{ flex: 1, flexWrap: 'wrap', flexDirection: 'row' }}>
                    ...
                    <StyledView style={{ width: '50%' }}>
                        <Link href={`/Desinsectisation/5`} asChild>
                            <Pressable className="flex">
                                <StyledView className="p-4 bg-white  shadow-md mb-4 w-35">
                                    <StyledImage
                                        source={école}
                    ...
                    <StyledView style={{ width: '50%' }}>
                        <Link href={`/Desinsectisation/6`} asChild>
                            <Pressable className="flex">
                                <StyledView className="p-4 bg-white  shadow-md mb-4 w-35">
                                    <StyledImage
                                        source={entreprise}
...
export default function DesinsectisationDetail() {
    return (
        <Provider store={store}>
            <DesinsectisationDetailApp/>
        </Provider>
    )
};
