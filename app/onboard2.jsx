    ...
    <SafeAreaProvider>
      <View style={{ paddingTop: inset.top }} className="flex flex-col   bg-white h-screen">
        <View className="w-full h-[60%] flex items-center ">
          <ImageBackground resizeMode="cover" className="w-full h-full items-center" source={require('@/assets/images/Pregnancy.png')}></ImageBackground>
        </View>
