    ...
    const validate = () => {
        if (service === "/api/services/1") {
            if (atHome) {
                ...
                if (!validateDateTime(serviceDateTime)) {
                    return false;
                }
                if (!adresse) {
                    Alert.alert("Erreur", 'Une adresse est requise')
                    return false;
                }
                return true;
            } else {
                ...
                if (!validateDateTime(pickupDateTime)) {
                    return false;
                }
                if (!adresse) {
                    Alert.alert("Erreur", 'Une adresse est requise')
                ...
                if (!executionLocation) {
                    Alert.alert("Erreur", 'Sélectionner un lieu pour le service')
                    return false;
                }
                return true;
            }
