    ...
    <SafeAreaView className=" flex-1 bg-white">
      ...
      <ScrollView className="bg-white p-4">
        <View className="mb-4">
          ...
          >
            <Text  className='text-gray-500 justify-center items-center'>Sélectionner une heure</Text>
          </TouchableOpacity>
          {showTimePicker && (
            <DateTimePicker
              value={time}
      ...
      <View className="absolute bottom-0 w-full p-4 bg-white  shadow-lg">
        ...
        >
          <Text className="text-white text-center text-lg">Commander le service</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
